...
DEFAULT_PERMISSIONS = {
    ...
    "Gestionnaire": {
        "dashboard": True, "supervision": False, "equipements": True,
        "doc_technique": True, "predictions": True, "base_connaissances": False,
        "sav": False, "facturation": True, "marches": True, "demandes": False, "planning": False,
        "pieces": True, "reports": True, "contrats": True, "conformite": False,
        "admin": False, "settings": False,
    },
    "Lecteur": {
        "dashboard": True, "supervision": True, "equipements": True,
        "doc_technique": True,
