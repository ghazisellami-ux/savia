...
export default function AiPrivacyPanel() {
  ...
  return (
    <section className="rounded-xl border border-savia-border bg-savia-surface p-5 space-y-4">
      <div className="flex gap-3"><Brain className="h-5 w-5 text-purple-400" /><div><h2 className="font-bold text-savia-text">IA et confidentialité</h2><p className="text-xs text-savia-text-muted mt-1">Gemini fournit des recommandations indicatives, sans modifier les données SAVIA.</p></div></div>
