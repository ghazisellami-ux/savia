  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <Image src="/logo-savia.png" alt="SAVIA" width={60} height={35} unoptimized className="object-contain" style={{ filter: 'brightness(0) invert(1) sepia(0.08) saturate(0.5) hue-rotate(15deg)' }} />
      </div>
